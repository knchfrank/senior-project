...
def print_all_flag():
    ...
    print('show_cancel' + ' : ' + str(show_cancel))
    print('-----------------------------------')
...
while not rospy.is_shutdown():
    ...
    if user_flag == 1 and flagrun == 1:
        if not show_cancel:
            text_box('Status : Not found user!',50,190,1200,150, silver)
    ...
    if arrived_flag == 0 and flagrun == 1 and user_flag == 2:
        text_box('Status : User not found ! Reset navigation.',50,190,1200,150, silver)
        delay(5000)
